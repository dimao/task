...
variable "private_key_path" {
  default = "~/.ssh/id_rsa"
  description = "The path to the private key to use to SSH into the created machine"
}

variable "provision" {
  description = "If true, provision script will be executed after vm deployment."
  default     = "false"
}
...
variable "provision_script_path" {
  ...
  description = "Path to provisioner script."
}
